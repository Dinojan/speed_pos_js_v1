angularApp.controller("UserController", [
    "$scope", "API_URL", "window", "jQuery", "$compile", "$uibModal", "$http", "$sce", "userAddModal", "UserEditModal", "UserGroupDeleteModal",
    function ($scope, API_URL, window, $, $compile, $uibModal, $http, $sce, userAddModal, UserEditModal, UserGroupDeleteModal) {
        var dt = $("#userTable");
        var i;
