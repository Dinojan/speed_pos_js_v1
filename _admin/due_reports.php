...
$document->setTitle(trans('title_due_reports'));
$document->setController('DueReportsController');
...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h3 class="card-title">
            <?php echo trans('text_outstanding_report'); ?>
        </h3>
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="due-report" class="table table-sm table-bordered table-striped" data-hide-colums="<?php echo $hide_colums; ?>">
