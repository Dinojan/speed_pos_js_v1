...
?>
<div class="wrapper" ng-controller="SupplierController">
    <!-- Preloader -->
                                ...
                                <ul class="list-group list-group-unbordered mb-3">
                                    ...
                                    <li class="list-group-item">
                                        <b> <?php echo trans('label_email'); ?></b> <a
                                            class="float-right">supplier@gmail.com</a>
                                    </li>
                                    <li class="list-group-item">
...
?>
<script src="../assets/speed_pos_js_v1/angular/controller/SupplierProfileController.js"></script>