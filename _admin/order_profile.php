    ...
    <div class="col-md-3">
        ...
        <div class="card card-primary card-outline">
            <div class="card-body box-profile">
                ...
                <h3 class="profile-username text-center"><?php echo $the_order['cus_name']?></h3>

                <p class="text-muted text-center"><?php echo trans('text_since'); ?>:
                  <?php echo $the_order['created_at']?>
                </p>

                <ul class="list-group list-group-unbordered mb-3">
                    <li class="list-group-item">
                        <b> <?php echo trans('label_mobile_phone'); ?></b> <a class="float-right"><?php echo $the_order['cus_mobile']?></a>
                    </li>
                    <li class="list-group-item">
                        <b> <?php echo trans('label_address'); ?></b> <a class="float-right"><?php echo $the_order['cus_address']?></a>
                    </li>
                    
                    <li class="list-group-item">
                        <b> <?php echo trans('label_due_limit'); ?></b> <a class="float-right"><?php echo $the_order['cus_name']?></a>
                    </li>
