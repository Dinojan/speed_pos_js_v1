<form class="form-row" id="supplier-del-form" method="post" onsubmit="return false">
  ...
  <div class="col-12 text-center mt-3">
    <button id="supplier-delete" class="btn btn-danger btn-sm" data-loading-text="Deleting...">
